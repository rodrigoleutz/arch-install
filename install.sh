...
pacstrap /mnt base linux linux-firmware espeakup alsa-utils grub efibootmgr nano networkmanager links git espeak-ng speech-dispatcher orca onboard xorg xorg-server mate mate-extra sudo xorg-xinit ufw
